		...
		<footer className="border-t border-border bg-background">
			<div className="mx-auto w-full max-w-7xl px-5 py-14 sm:px-8">
                ...
                <p className="mt-5 text-xs leading-relaxed text-muted-foreground">
                    Modelo 3D “<a className="underline underline-offset-2 hover:text-foreground" href="https://skfb.ly/oDPCS" target="_blank" rel="noopener noreferrer">Modern Office</a>” por{' '}
                    <a className="underline underline-offset-2 hover:text-foreground" href="https://skfb.ly/oDPCS" target="_blank" rel="noopener noreferrer">dylanheyes</a> —{' '}
                    <a className="underline underline-offset-2 hover:text-foreground" href="https://creativecommons.org/licenses/by/4.0/" target="_blank" rel="noopener noreferrer">CC BY 4.0</a>. Adaptado para AVLS.
                    <span className="block mt-1">Materiais, arte e ambientação adaptados para a AVLS.</span>
                </p>
			</div>
		</footer>
	);
