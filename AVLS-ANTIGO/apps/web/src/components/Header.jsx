								...
								<nav className="flex flex-col gap-1" aria-label="Menu móvel">
									{NAV_LINKS.map((link, index) => (
										<a
											...
											className="group flex items-center justify-between border-b border-border/70 py-4 font-display text-2xl font-semibold text-foreground transition-colors hover:text-transparent hover:[background:linear-gradient(92deg,#965e3f,#876c46,#58664c)] hover:[-webkit-background-clip:text] hover:[background-clip:text]"
										>
											{link.label}
