	...
	return (
		<section className="py-10 sm:py-14" aria-label="Chamada para contato">
			<div className="mx-auto w-full max-w-7xl px-5 sm:px-8">
				<Reveal>
					<div className="relative overflow-hidden rounded-3xl bg-[#211c18] px-7 py-12 sm:px-12 sm:py-16">
						<div
							className="pointer-events-none absolute -right-24 -top-24 h-72 w-72 rounded-full opacity-40 blur-3xl"
							style={{
								background: 'linear-gradient(135deg,#965e3f,#876c46,#58664c)',
							}}
							aria-hidden="true"
						/>
						<div
							className="pointer-events-none absolute -bottom-28 -left-16 h-64 w-64 rounded-full opacity-25 blur-3xl"
							style={{ background: 'linear-gradient(135deg,#876c46,#58664c)' }}
							aria-hidden="true"
						/>
