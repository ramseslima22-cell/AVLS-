...
export default function Videos() {
	...
	return (
		<section id="videos" className="py-20 text-foreground sm:py-28">
					...
					{videos.map((video, index) => (
						<Reveal key={video.id} delay={index * 0.08}>
							<button
								...
								className="group relative block w-full overflow-hidden rounded-2xl border border-border bg-card text-foreground text-left transition-all duration-300 hover:-translate-y-1.5 hover:border-foreground/30 hover:shadow-[0_32px_64px_-28px_rgba(0,0,0,0.8)]"
